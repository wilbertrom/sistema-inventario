...
.page-header h2 {
    font-size: 17px; font-weight: 700; color: var(--texto-dark); margin: 0;
}
...
.btn-r:hover {
    box-shadow: 0 5px 15px rgba(165,33,25,.3); transform: translateY(-1px);
...
.btn-outline:hover {
    background: #f1f5f9; color: var(--texto-dark); text-decoration: none;
}
...
table.inv-t thead th {
    background: var(--rojo);  /* Cambiado de #1e293b a #a52119 */
    color: white; font-size: 11px; font-weight: 600;
    text-transform: uppercase; letter-spacing: .4px; padding: 12px 14px;
    border: none; white-space: nowrap;
}
table.inv-t tbody tr {
    border-bottom: 1px solid var(--gris-borde); transition: background .15s;
}
table.inv-t tbody tr:hover { background: #fafbfc; }
table.inv-t td {
    padding: 11px 14px; font-size: 13px; color: var(--texto-mid);
...
.equipo-card-num {
    background: var(--rojo); color: white; font-size: 11px;
    font-weight: 700; padding: 2px 8px; border-radius: 20px;
    white-space: nowrap;
}
.equipo-card-tipo {
    font-size: 13.5px; font-weight: 700; color: var(--texto-dark); flex: 1;
}
.equipo-card-body {
...
.equipo-card-row .lbl {
    color: var(--texto-mid); display: block; font-size: 11px;
...
/* ── Empty / Pagination ── */
.empty-state {
    padding: 50px 20px; text-align: center; color: var(--texto-mid);
}
.empty-state i {
    font-size: 44px; color: #cbd5e1; display: block; margin-bottom: 12px;
}
.pagination-wrap {
