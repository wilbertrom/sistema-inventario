...
<body class="animsition">
            ...
            <div class="container">
                <div class="login-wrap">
                    <div class="login-content">
                        ...
                        <?php if (isset($error)) { echo '<div class="error alert alert-warning">'.$error.'</div>'; } ?>
                        <?php echo form_open('login/do_login'); ?>
                            <div class="login-form">
                                <form action="" method="post">
                                    <div class="form-group">
                                        <label>Usuario</label>
                                        <input class="au-input au-input--full" type="username" name="username" placeholder="">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <a href="<?php echo base_url('portal/acerca_de')?>" class="au-btn--block"><button class="au-btn au-btn--block au-btn--secondary m-b-20" type="button">Regresar</button></a>
    ...
    <!-- Vendor JS       -->
    <script src="<?php echo base_url('recursos-panel/');?>vendor/slick/slick.min.js">
    </script>
    ...
    <script src="<?php echo base_url('recursos-panel/');?>vendor/bootstrap-progressbar/bootstrap-progressbar.min.js">
    </script>
    <script src="<?php echo base_url('recursos-panel/');?>vendor/counter-up/jquery.waypoints.min.js"></script>
    <script src="<?php echo base_url('recursos-panel/');?>vendor/counter-up/jquery.counterup.min.js">
    </script>
    ...
    <script src="<?php echo base_url('recursos-panel/');?>vendor/select2/select2.min.js">
    </script>
