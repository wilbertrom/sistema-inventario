    ...
    <div class="form-card-body">
        ...
        <form action="<?php echo base_url('orden-mantenimiento/crear'); ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="f-group">
                        ...
                        <select name="solicitante" class="f-control" required>
                            <option value="">— Selecciona —</option>
                            <?php foreach($firmantes_resp as $f): ?>
                            <option value="<?php echo htmlspecialchars($f->nombre); ?>"
                                <?php echo (set_value('solicitante') == $f->nombre) ? 'selected' : ''; ?>>
            ...
            <p style="font-size:13px;font-weight:700;color:#1e293b;margin-bottom:14px;">
                <i class="fa fa-signature" style="color:#a52119;"></i> Firmantes
            </p>
                ...
                <div class="col-md-6">
                    <div class="f-group">
                        ...
                        <select name="responsable_mantenimiento" class="f-control">
                            ...
                            <?php foreach($firmantes_resp as $f): ?>
                            <option value="<?php echo htmlspecialchars($f->nombre); ?>"
                                <?php echo (set_value('responsable_mantenimiento') == $f->nombre) ? 'selected' : ''; ?>>
                                <?php echo htmlspecialchars($f->nombre); ?>
                            </option>
                            <?php endforeach; ?>
                        </select>
                ...
                <div class="col-md-6">
                    <div class="f-group">
                        ...
                        <select name="verificado_por" class="f-control">
                            ...
                            <option value="<?php echo htmlspecialchars($f->nombre); ?>"
                                <?php echo (set_value('verificado_por') == $f->nombre) ? 'selected' : ''; ?>>
                                <?php echo htmlspecialchars($f->nombre); ?>
                            </option>
                            <?php endforeach; ?>
                        </select>
