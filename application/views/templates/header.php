...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; }
        ...
        .header-desktop {
            background: #ffffff;
            box-shadow: 0 4px 20px rgba(165, 33, 25, 0.12);
            position: fixed;
        ...
        /* ── Logo ── */
        .header-logo { display: flex; align-items: center; min-width: 210px; }
        ...
        .header-nav-link i { font-size: 15px; color: #a52119; transition: color 0.25s; }

        .header-nav-link:hover,
        .header-nav-link:focus,
        .header-nav-link.active {
            background: linear-gradient(135deg, #a52119 0%, #c0392b 100%);
            color: #fff;
            transform: translateY(-2px);
            box-shadow: 0 6px 16px rgba(165, 33, 25, 0.28);
            text-decoration: none;
        }

        .header-nav-link:hover i,
        .header-nav-link:focus i,
        .header-nav-link.active i { color: #fff; }
        ...
        /* ── Perfil de usuario ── */
        .header-button { min-width: 190px; display: flex; justify-content: flex-end; }
        ...
        .account-item:hover {
            background: linear-gradient(135deg, #a52119, #c0392b);
        ...
        .account-dropdown .info .email  { color: rgba(255,255,255,0.8); font-size: 11.5px; margin-top: 2px; }
        ...
        .account-dropdown__footer a {
            display: flex; align-items: center; gap: 10px;
            padding: 11px 20px;
            color: #dc3545; font-size: 13.5px;
            transition: background 0.2s;
        }

        .account-dropdown__footer a i { width: 20px; }
        .account-dropdown__footer a:hover { background: #fff5f5; text-decoration: none; }

        /* ── Contenido principal ──
           !important necesario para sobrevivir al reset global del tema */
        .page-container {
        ...
        @media (max-width: 1199px) {
            ...
            .header-nav-link { padding: 9px 13px; font-size: 12.5px; }
        }
        ...
        <div class="container-fluid">
            <div class="header-mobile-inner">
                <a class="logo" href="<?php echo base_url(); ?>">
                    <img src="<?php echo base_url('recursos-portal/'); ?>images/icon/UPTx_Logo.png"
                         alt="Logo UPTx" style="height: 42px;">
                </a>
            ...
            <div class="header-wrap">
                ...
                <div class="header-nav">
                    <ul>
                        ...
                        <!-- Inventario -->
                        <li class="dropdown">
                            <a href="#" class="header-nav-link dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <i class="fas fa-desktop"></i> Inventario
                            </a>
